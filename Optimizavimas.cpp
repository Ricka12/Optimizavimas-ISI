...
int main()
{
	...
	while (pabaiga != 1)
	{
		...
		if(x1<=3)
		{
			R << "plot(" << x1 << ", " << fx1 << ", \"r+\")" << endl;
		}
		if(x2<=3)
		{
			R << "plot(" << x2 << ", " << fx2 << ", \"r+\")" << endl;
		}
		if(xm<=3)
		{ 
	...
	if(fx1<=fxm&&fx1<=fx2)
	{ 
		cout << "Intervalo dalijimo pusiau metodas" << endl << "Minimumas x : " << x1 << " y : " << fx1 << " skaiciavimu kiekis : " << skaiciavimuKiekisDalijimoPusiau << " Zingsniu skaicius : " << iteracijuSkDalPus << endl;
	}
	else if (fxm <= fx1 && fxm <= fx2)
	{
		...
		cout << "Intervalo dalijimo pusiau metodas" << endl << "Minimumas x : " << x2 << " y : " << fx2 << " skaiciavimu kiekis : " << skaiciavimuKiekisDalijimoPusiau << " Zingsniu skaicius : " << iteracijuSkDalPus << endl;
	}
	//////////////////////////////////////////////////////////////////////////////////////
	...
	{
		cout << endl << "Auksinio pjuvio metodas" << endl << "Minimumas: " << x1 << " y : " << fx1 << " skaiciavimu kiekis : " << skaiciavimuKiekisAuksinisPjuvis << " Zingsniu skaicius : " << iteracijuSkAukPjuv << endl;
	}
	//////////////////////////////////////////////////////////////////////////////////////
	//Niutono metodas
	//////////////////////////////////////////////////////////////////////////////////////
